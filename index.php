...
<head>
    ...
    <title> Sanaka Hospital management System </title>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">SHMS
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Sanaka Hospital Management System</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <ul class="list-unstyled link-list">
                        ...
                        <li><a ui-sref="portfolio" href="#gallery">Gallery</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="products" href="#services">Services</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="gallery" href="#contact">Contact us</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="contact" href="#logins">Login</a><i class="fa fa-angle-right"></i></li>
                    </ul>
                </div>
...
?>
                     ...
                     <p>Malandighi ,Paschim Bardhaman,West Bengal,India
    ...
    <div class="copy">
            <div class="container">
         Sanaka Hospital Management System
